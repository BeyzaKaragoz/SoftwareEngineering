...
$users = $db->query("SELECT * FROM users WHERE (username LIKE '{$keyword}') OR (name LIKE '{$keyword}' OR surname LIKE '{$keyword}') OR (CONCAT(name, ' ', surname) LIKE '{$keyword}')")->fetchAll();
?>
...
<div class="container">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title text-center">Welcome Search Tab! You can search Student</h5>
            <hr>
            <ul class="list-group">
