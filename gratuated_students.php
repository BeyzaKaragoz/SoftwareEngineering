...
$db = db_connect();
$users = $db->query("SELECT * FROM users WHERE type = '2'")->fetchAll();
?>
                        ...
                        <div class="row no-gutters student">
                            ...
                            <div class="col-md-10">
                                <div class="card-body">
                                    ...
                                    <p class="card-text m-0"><span class="font-weight-bold">Company:</span> <?php echo $user["company"]; ?></p>
                                    <p class="card-text m-0"><span class="font-weight-bold">Information:</span> <?php echo $user["information"]; ?></p>
                                    <hr>
